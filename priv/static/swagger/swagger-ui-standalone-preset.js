...
!(function webpackUniversalModuleDefinition(t, e) {
  ...
  (() => {
    var t = {
          ...
          function base64ToBytes(t) {
            return n.toByteArray(
              (function base64clean(t) {
                if (
                  (t = (t = t.split("=")[0]).trim().replace(c, "")).length < 2
                )
                  return "";
                for (; t.length % 4 != 0; ) t += "=";
                return t;
        ...
        9404(t) {
          t.exports = (function () {
            ...
            function ensureSize(t) {
              return (
                void 0 === t.size && (t.size = t.__iterate(returnTrue)),
                t.size
              );
            }
            ...
            ((Seq.prototype[w] = !0),
              ...
              (Range.prototype.get = function (t, e) {
                return this.has(t)
                  ? this._start + wrapIndex(this, t) * this._step
                  : e;
              }),
              ...
              (Range.prototype.__iterator = function (t, e) {
                ...
                return new Iterator(function () {
                  ...
                  return (
                    (o += e ? -n : n),
                    i > r ? iteratorDone() : iteratorValue(t, i++, a)
                  );
                });
              }),
            ...
            function hash(t) {
              ...
              if ("string" === e)
                return t.length > L ? cachedHashString(t) : hashString(t);
            ...
            function hashJSObj(t) {
              ...
              if (!B) {
                if (
                  void 0 !==
                  (e = t.propertyIsEnumerable && t.propertyIsEnumerable[q])
                )
                  return e;
            ...
            function mergeIntoNode(t, e, r, n, o) {
              if (t.keyHash === n)
                return new HashCollisionNode(e, n, [t.entry, o]);
              var i,
              ...
              return new BitmapIndexedNode(
                ...
                (1 << s) | (1 << c),
                s === c
                  ? [mergeIntoNode(t, e, r + a, n, o)]
                  : ((i = new ValueNode(e, n, o)), s < c ? [t, i] : [i, t]),
              );
            }
            function createNodes(t, e, r, n) {
              t || (t = new OwnerID());
              for (
                var o = new ValueNode(t, hash(r), [r, n]), i = 0;
                i < e.length;
                i++
              ) {
                var a = e[i];
            ...
            function packNodes(t, e, r, n) {
              for (
                var o = 0, i = 0, a = new Array(r), s = 0, u = 1, c = e.length;
                s < c;
                s++, u <<= 1
              ) {
                var f = e[s];
            ...
            function expandNodes(t, e, r, n, o) {
              for (var i = 0, a = new Array(s), u = 0; 0 !== r; u++, r >>>= 1)
                a[u] = 1 & r ? e[i++] : void 0;
            ...
            ((V[W] = !0),
              ...
              (ArrayMapNode.prototype.get = function (t, e, r, n) {
                for (var o = this.entries, i = 0, a = o.length; i < a; i++)
                  if (is(r, o[i][0])) return o[i][1];
                return n;
              }),
              (ArrayMapNode.prototype.update = function (t, e, r, n, o, i, a) {
                for (
                  var s = o === c, u = this.entries, f = 0, l = u.length;
                  f < l && !is(n, u[f][0]);
                  f++
                );
                var p = f < l;
              ...
              (BitmapIndexedNode.prototype.get = function (t, e, r, n) {
                ...
                var o = 1 << ((0 === t ? e : e >>> t) & u),
                  i = this.bitmap;
                return i & o
                  ? this.nodes[popCount(i & (o - 1))].get(t + a, e, r, n)
                  : n;
              }),
              (BitmapIndexedNode.prototype.update = function (
                ...
                if (h && !g && 2 === y.length && isLeafNode(y[1 ^ d]))
                  return y[1 ^ d];
              ...
              (HashArrayMapNode.prototype.update = function (
                ...
                var _ = t && t === this.ownerID,
                  g = setIn(p, f, d, _);
                return _
                  ? ((this.count = y), (this.nodes = g), this)
                  : new HashArrayMapNode(t, y, g);
              }),
              ...
              (HashCollisionNode.prototype.update = function (
                ...
                var p = f < l;
                if (p ? u[f][1] === o : s) return this;
                if ((SetRef(a), (s || !p) && SetRef(i), s && 2 === l))
                ...
                return (
                  ...
                  h
                    ? ((this.entries = d), this)
                    : new HashCollisionNode(t, this.keyHash, d)
                );
              }),
                  ...
                  : (SetRef(a),
                    s
                      ...
                      : u
                        ...
                        : (SetRef(i),
                          mergeIntoNode(this, t, e, hash(n), [n, o])));
              }),
              (ArrayMapNode.prototype.iterate =
                HashCollisionNode.prototype.iterate =
                  function (t, e) {
                    for (
                      var r = this.entries, n = 0, o = r.length - 1;
                      n <= o;
                      n++
                    )
              ...
              (BitmapIndexedNode.prototype.iterate =
                HashArrayMapNode.prototype.iterate =
                  function (t, e) {
                    for (
                      var r = this.nodes, n = 0, o = r.length - 1;
                      n <= o;
                      n++
                    ) {
                      var i = r[e ? o - n : n];
            ...
            ((Z[Y] = !0),
              ...
              (VNode.prototype.removeBefore = function (t, e, r) {
                ...
                if (e > 0) {
                  var s = this.array[n];
                  if ((o = s && s.removeBefore(t, e - a, r)) === s && i)
                    return this;
                }
                if (i && !o) return this;
            ...
            function updateVNode(t, e, r, n, o, i) {
              ...
              if (r > 0) {
                ...
                return p === l
                  ? t
                  : (((s = editableVNode(t, e)).array[c] = p), s);
              }
            ...
            function setListBounds(t, e, r) {
              ...
              var y = t._tail,
                _ =
                  d < h ? listNodeFor(t, c - 1) : d > h ? new VNode([], n) : y;
                  ...
                  return new Iterator(function () {
                    for (;;) {
                      ...
                      var u = i.value,
                        ...
                        f = u[1];
                      if (e.call(r, f, c, t))
                        return iteratorValue(o, n ? c : s++, f, i);
                    }
                  });
                }),
                o
            ...
            function sliceFactory(t, e, r, n) {
              ...
              var i = resolveBegin(e, o),
                a = resolveEnd(r, o);
              if (i != i || a != a)
                return sliceFactory(t.toSeq().cacheResult(), e, r, n);
              var s,
                u = a - i;
              u == u && (s = u < 0 ? 0 : u);
              ...
              return (
                ...
                !n &&
                  ...
                  s >= 0 &&
                  (c.get = function (e, r) {
                    return (e = wrapIndex(this, e)) >= 0 && e < s
                      ? t.get(e + i, r)
                      : r;
                  }),
                ...
                (o.__iterateUncached = function (o, i) {
                  ...
                  return (
                    t.__iterate(function (t, i, c) {
                      if (!s || !(s = e.call(r, t, i, c)))
                        return (u++, o(t, n ? i : u - 1, a));
                    }),
                    u
                  );
                }),
            ...
            function makeSequence(t) {
              return Object.create(
                (isKeyed(t) ? KeyedSeq : isIndexed(t) ? IndexedSeq : SetSeq)
                  .prototype,
              );
            }
            ...
            (createClass(OrderedMap, Map),
              ...
              (ToKeyedSequence.prototype.__iterator = function (t, e) {
                ...
                return new Iterator(function () {
                  ...
                  return o.done
                    ? o
                    : iteratorValue(t, e ? --n : n++, o.value, o);
                });
              }),
              ...
              (Record.prototype.set = function (t, e) {
                if (!this.has(t))
                  throw new Error(
                    'Cannot set unknown key "' + t + '" on ' + recordName(this),
                  );
                if (
                  this._map &&
                  !this._map.has(t) &&
            ...
            function mixin(t, e) {
              ...
              return (
                ...
                Object.getOwnPropertySymbols &&
                  Object.getOwnPropertySymbols(e).forEach(keyCopier),
                t
              );
            }
            function isProtoKey(t) {
              return (
                "string" == typeof t &&
                ("__proto__" === t || "constructor" === t)
              );
            }
            ((lt[ct] = !0),
              ...
              mixin(Iterable, {
                ...
                isSuperset: function (t) {
                  return (t =
                    "function" == typeof t.isSubset ? t : Iterable(t)).isSubset(
                    this,
                  );
                },
                keyOf: function (t) {
              ...
              mixin(IndexedIterable, {
                ...
                splice: function (t, e) {
                  ...
                  return reify(
                    ...
                    1 === r
                      ? n
                      : n.concat(arrCopy(arguments, 2), this.slice(t + e)),
                  );
                },
        ...
        7068(t, e, r) {
          ...
          t.exports = function baseIsEqualDeep(t, e, r, y, _, g) {
            ...
            if (B && !I)
              return (
                g || (g = new n()),
                m || f(t) ? o(t, e, r, y, _, g) : i(t, e, b, r, y, _, g)
              );
            if (!(1 & r)) {
          ...
          t.exports = function equalByTag(t, e, r, n, c, l, p) {
            switch (r) {
              ...
              case "[object ArrayBuffer]":
                return !(
                  t.byteLength != e.byteLength || !l(new o(t), new o(e))
                );
              case "[object Boolean]":
              case "[object Date]":
              case "[object Number]":
          ...
          s && s.getRandomValues
            ? (t.exports = function randomBytes(t, e) {
                ...
                if (t > 0)
                  if (t > o)
                    for (var u = 0; u < t; u += o)
                      s.getRandomValues(r.slice(u, u + o));
        ...
        5287(t, e) {
          ...
          function M(t, e, n) {
            ...
            if (t && t.defaultProps)
              for (o in (u = t.defaultProps)) void 0 === i[o] && (i[o] = u[o]);
            return {
              $$typeof: r,
              type: t,
              key: a,
            ...
            (e.cloneElement = function (t, e, n) {
              ...
              if (null != e) {
                ...
                for (c in e)
                  v.call(e, c) &&
                    !w.hasOwnProperty(c) &&
                    (o[c] = void 0 === e[c] && void 0 !== u ? u[c] : e[c]);
              }
        ...
        2802(t, e, r) {
          ...
          ((t.exports = function SHA(e) {
            ...
            if (!n)
              throw new Error(
                r + " is not supported (we accept pull requests)",
              );
            return new n();
          }),
        ...
        5377(t, e, r) {
          ...
          var n = r(2861).Buffer,
            ...
            c =
              u && (n.prototype instanceof Uint8Array || n.TYPED_ARRAY_SUPPORT);
    ...
    return (
      (() => {
        "use strict";
        __webpack_require__.d(r, { default: () => ce });
        var t = {};
        (__webpack_require__.r(t),
          ...
          render() {
            ...
            return n.createElement(
              ...
              n.createElement(
                r,
                null,
                n.createElement(o, null, n.createElement(s, null)),
              ),
            );
          }
        }
        ...
        class TopBar extends n.Component {
          ...
          render() {
            ...
            const c = ["download-url-input"];
            ("failed" === e.loadingStatus() && c.push("failed"),
              u && c.push("loading"));
            const { urls: f } = r();
            let l = [],
              p = null;
            if (f) {
              ...
              (f.forEach((e, r) => {
                t.push(
                  n.createElement("option", { key: r, value: e.url }, e.name),
                );
              }),
                l.push(
                  n.createElement(
                    ...
                    n.createElement(
                      "select",
                      {
                        ...
                        value: f[this.state.selectedIndex].url,
                      },
                      t,
                    ),
                  ),
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    l.map((t, e) => (0, n.cloneElement)(t, { key: e })),
                  ),
        ...
        var J;
        function lightbulb_extends() {
          return (
            (lightbulb_extends = Object.assign
              ? Object.assign.bind()
              : function (t) {
                  for (var e = 1; e < arguments.length; e++) {
                    var r = arguments[e];
            ...
            lightbulb_extends.apply(null, arguments)
          );
        }
        const lightbulb = (t) =>
          n.createElement(
        ...
        var tt;
        function lightbulb_off_extends() {
          return (
            (lightbulb_off_extends = Object.assign
              ? Object.assign.bind()
              : function (t) {
                  for (var e = 1; e < arguments.length; e++) {
                    var r = arguments[e];
            ...
            lightbulb_off_extends.apply(null, arguments)
          );
        }
        const lightbulb_off = (t) =>
          n.createElement(
            "svg",
            lightbulb_off_extends(
              { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" },
              t,
            ),
            tt ||
              (tt = n.createElement("path", {
                d: "M12 2C9.76 2 7.78 3.05 6.5 4.68l9.81 9.82C17.94 13.21 19 11.24 19 9a7 7 0 0 0-7-7M3.28 4 2 5.27 5.04 8.3C5 8.53 5 8.76 5 9c0 2.38 1.19 4.47 3 5.74V17a1 1 0 0 0 1 1h5.73l4 4L20 20.72zM9 20v1a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-1z",
              })),
          );
        class DarkModeToggle extends n.Component {
          constructor(t) {
            (super(t),
              (this.state = { isDarkMode: !1 }),
              (this.toggleIsDarkMode = this.toggleIsDarkMode.bind(this)));
          }
          componentDidMount() {
            window.matchMedia("(prefers-color-scheme: dark)").matches &&
              (document.documentElement.classList.add("dark-mode"),
              this.setState({ isDarkMode: !0 }));
          }
          toggleIsDarkMode() {
            (document.documentElement.classList.toggle("dark-mode"),
              this.setState((t) => ({ isDarkMode: !t.isDarkMode })));
          }
          render() {
            const { isDarkMode: t } = this.state;
            return n.createElement(
              "div",
              ...
              n.createElement(
                ...
                t
                  ? n.createElement(lightbulb, { height: "24" })
                  : n.createElement(lightbulb_off, { height: "24" }),
              ),
            );
          }
        }
        const et = DarkModeToggle,
          top_bar = () => ({
            components: {
              Topbar: u,
        ...
        function getLine(t, e, r, n, o) {
          ...
          return (
            ...
            {
              str: i + t.slice(e, r).replace(/\t/g, "→") + a,
              pos: n - e + i.length,
            }
          );
        }
        function padStart(t, e) {
          return rt.repeat(" ", e - t.length) + t;
        }
        var ot = function makeSnippet(t, e) {
            ...
            for (
              ...
              (i.push(r.index),
                ...
                t.position <= r.index && a < 0 && (a = o.length - 2));
            a < 0 && (a = o.length - 1);
            var s,
              u,
              c = "",
          ...
          at = ["scalar", "sequence", "mapping"];
        var st = function Type$1(t, e) {
          if (
            ((e = e || {}),
        ...
        var ut = Schema$1,
          ct = new st("tag:yaml.org,2002:str", {
            kind: "scalar",
            construct: function (t) {
              return null !== t ? t : "";
            },
          }),
          lt = new st("tag:yaml.org,2002:seq", {
            kind: "sequence",
            construct: function (t) {
              return null !== t ? t : [];
            },
          }),
          pt = new st("tag:yaml.org,2002:map", {
            kind: "mapping",
            construct: function (t) {
              return null !== t ? t : {};
            },
          }),
          ht = new ut({ explicit: [ct, lt, pt] });
        var dt = new st("tag:yaml.org,2002:null", {
          kind: "scalar",
        ...
        var yt = new st("tag:yaml.org,2002:bool", {
          kind: "scalar",
        ...
        var _t = new st("tag:yaml.org,2002:int", {
            kind: "scalar",
        ...
        var mt = /^[-+]?[0-9]+e/;
        var vt = new st("tag:yaml.org,2002:float", {
            kind: "scalar",
            resolve: function resolveYamlFloat(t) {
              return null !== t && !(!gt.test(t) || "_" === t[t.length - 1]);
            },
            ...
            represent: function representYamlFloat(t, e) {
              ...
              else if (rt.isNegativeZero(t)) return "-0.0";
              return (
                (r = t.toString(10)),
                mt.test(r) ? r.replace("e", ".e") : r
              );
            },
            defaultStyle: "lowercase",
          }),
          bt = ht.extend({ implicit: [dt, yt, _t, vt] }),
          St = bt,
          wt = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),
          It = new RegExp(
            "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$",
          );
        var xt = new st("tag:yaml.org,2002:timestamp", {
          kind: "scalar",
          resolve: function resolveYamlTimestamp(t) {
            return null !== t && (null !== wt.exec(t) || null !== It.exec(t));
          },
          construct: function constructYamlTimestamp(t) {
            var e,
              ...
              c = 0,
              f = null;
            if ((null === (e = wt.exec(t)) && (e = It.exec(t)), null === e))
              throw new Error("Date resolve error");
            if (((r = +e[1]), (n = +e[2] - 1), (o = +e[3]), !e[4]))
        ...
        var Et = new st("tag:yaml.org,2002:merge", {
            kind: "scalar",
          ...
          At =
            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=\n\r";
        var Ot = new st("tag:yaml.org,2002:binary", {
            kind: "scalar",
        ...
        var Mt = new st("tag:yaml.org,2002:omap", {
            kind: "sequence",
            resolve: function resolveYamlOmap(t) {
              ...
              for (e = 0, r = s.length; e < r; e += 1) {
                if (((n = s[e]), (i = !1), "[object Object]" !== kt.call(n)))
                  return !1;
                for (o in n)
                  if (Bt.call(n, o)) {
                    if (i) return !1;
        ...
        var jt = new st("tag:yaml.org,2002:pairs", {
            kind: "sequence",
            resolve: function resolveYamlPairs(t) {
              ...
              var e,
                ...
                a = t;
              for (
                i = new Array(a.length), e = 0, r = a.length;
                e < r;
                e += 1
              ) {
                if (((n = a[e]), "[object Object]" !== Ct.call(n))) return !1;
        ...
        var Lt = new st("tag:yaml.org,2002:set", {
            kind: "mapping",
            resolve: function resolveYamlSet(t) {
              if (null === t) return !0;
              var e,
                r = t;
              for (e in r) if (qt.call(r, e) && null !== r[e]) return !1;
              return !0;
            },
          ...
          Nt = St.extend({ implicit: [xt, Et], explicit: [Ot, Mt, jt, Lt] }),
        ...
        for (
          var zt = new Array(256), Wt = new Array(256), Vt = 0;
          Vt < 256;
          Vt++
        )
          ((zt[Vt] = simpleEscapeSequence(Vt) ? 1 : 0),
            (Wt[Vt] = simpleEscapeSequence(Vt)));
        ...
        function generateError(t, e) {
          ...
          return ((r.snippet = ot(r)), new nt(e, r));
        }
        ...
        var Kt = {
          YAML: function handleYamlDirective(t, e, r) {
            ...
            (null !== t.version &&
              ...
              1 !== r.length &&
                throwError(t, "YAML directive accepts exactly one argument"),
              null === (n = /^([0-9]+)\.([0-9]+)$/.exec(r[0])) &&
                throwError(t, "ill-formed argument of the YAML directive"),
              (o = parseInt(n[1], 10)),
              (i = parseInt(n[2], 10)),
              1 !== o &&
                throwError(t, "unacceptable YAML version of the document"),
              (t.version = r[0]),
              (t.checkLineBreaks = i < 2),
              1 !== i &&
                2 !== i &&
                throwWarning(t, "unsupported YAML version of the document"));
          },
          TAG: function handleTagDirective(t, e, r) {
            var n, o;
            (2 !== r.length &&
              throwError(t, "TAG directive accepts exactly two arguments"),
              (n = r[0]),
              (o = r[1]),
              Ut.test(n) ||
                throwError(
        ...
        function captureSegment(t, e, r, n) {
          ...
          if (e < r) {
            if (((s = t.input.slice(e, r)), n))
              ...
              Pt.test(s) &&
                throwError(t, "the stream contains non-printable characters");
            t.result += s;
          }
        }
        function mergeMappings(t, e, r, n) {
          ...
          for (
            ...
            ((i = o[a]),
              Tt.call(e, i) || (setProperty(e, i, r[i]), (n[i] = !0)));
        }
        function storeMappingPair(t, e, r, n, o, i, a, s, u) {
          ...
          if (Array.isArray(o))
            for (
              ...
              (Array.isArray(o[c]) &&
                throwError(t, "nested arrays are not supported inside keys"),
                "object" == typeof o &&
                  "[object Object]" === _class(o[c]) &&
                  (o[c] = "[object Object]"));
          if (
            ("object" == typeof o &&
              "[object Object]" === _class(o) &&
              (o = "[object Object]"),
            (o = String(o)),
            null === e && (e = {}),
            ...
            if (Array.isArray(i))
              for (c = 0, f = i.length; c < f; c += 1)
                mergeMappings(t, e, i[c], r);
        ...
        function readTagProperty(t) {
          ...
          n &&
            !Dt.test(n) &&
            throwError(t, "tag name cannot contain such characters: " + n);
          try {
        ...
        function composeNode(t, e, r, n, o) {
          ...
          if (
                          ...
                          if (
                            ((t.line === i || t.lineIndent > e) &&
                              (g &&
                                ...
                                (s = t.lineStart),
                                (u = t.position)),
                              composeNode(t, e, 4, !0, o) &&
                                (g ? (y = t.result) : (_ = t.result)),
                              g ||
                                (storeMappingPair(t, p, h, d, y, _, a, s, u),
                                (d = y = _ = null)),
                              skipSeparationSpace(t, !0, -1),
                              (c = t.input.charCodeAt(t.position))),
                  ...
                  (function readFlowCollection(t, e) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        (h = t.input.charCodeAt(t.position)) === a)
                      )
                        return (
                          t.position++,
                          (t.tag = y),
                      ...
                      (d
                        ...
                        c
                          ...
                          : s
                            ? i.push(
                                storeMappingPair(t, null, g, l, f, p, r, n, o),
                              )
                            : i.push(f),
                        skipSeparationSpace(t, !0, e),
                  ...
                  : ((a &&
                      (function readBlockScalar(t, e) {
                        var r,
                          ...
                          l = 0,
                          p = !1;
                        if (124 === (i = t.input.charCodeAt(t.position)))
                          n = !1;
                        else {
                          if (62 !== i) return !1;
                          n = !0;
                        ...
                        for (t.kind = "scalar", t.result = ""; 0 !== i; )
                          if (
                            43 === (i = t.input.charCodeAt(++t.position)) ||
                            45 === i
                          )
                            1 === s
                              ? (s = 43 === i ? 3 : 2)
                        ...
                        ? (function readPlainScalar(t, e, r) {
                            ...
                            for (
                              ...
                              if (58 === f) {
                                ...
                                if (
                                  is_WS_OR_EOL(
                                    t.input.charCodeAt(t.position - 1),
                                  )
                                )
                                  break;
                              } else {
            ...
            if (Tt.call(t.typeMap[t.kind || "fallback"], t.tag))
        ...
        function readDocument(t) {
          ...
          for (
            ...
            for (
              ...
              if (is_EOL(o)) break;
              for (e = t.position; 0 !== o && !is_WS_OR_EOL(o); )
                o = t.input.charCodeAt(++t.position);
          ...
          (skipSeparationSpace(t, !0, -1),
            ...
            skipSeparationSpace(t, !0, -1),
            t.checkLineBreaks &&
              Rt.test(t.input.slice(i, t.position)) &&
              throwWarning(
                t,
        ...
        function encodeHex(t) {
          ...
          return "\\" + r + rt.repeat("0", n - e.length) + e;
        }
        function State(t) {
          ((this.schema = t.schema || Nt),
            ...
            (this.flowLevel = rt.isNothing(t.flowLevel) ? -1 : t.flowLevel),
            (this.styleMap = (function compileStyleMap(t, e) {
              var r, n, o, i, a, s, u;
              if (null === e) return {};
              for (
                r = {}, o = 0, i = (n = Object.keys(e)).length;
                o < i;
                o += 1
              )
                ((a = n[o]),
        ...
        function indentString(t, e) {
          for (
            var r, n = rt.repeat(" ", e), o = 0, i = -1, a = "", s = t.length;
            o < s;
          )
            (-1 === (i = t.indexOf("\n", o))
              ? ((r = t.slice(o)), (o = s))
              : ((r = t.slice(o, i + 1)), (o = i + 1)),
              r.length && "\n" !== r && (a += n),
              (a += r));
          return a;
        }
        function generateNextLine(t, e) {
          return "\n" + rt.repeat(" ", t.indent * e);
        }
        ...
        function isPrintable(t) {
          return (
            ...
            (57344 <= t && t <= 65533 && t !== Gt) ||
            (65536 <= t && t <= 1114111)
          );
        }
        function isNsCharOrWhitespace(t) {
          return isPrintable(t) && t !== Gt && 13 !== t && 10 !== t;
        }
        ...
        function writeScalar(t, e, r, n, o) {
          t.dump = (function () {
            ...
            if (!t.noCompatMode && (-1 !== Jt.indexOf(e) || Qt.test(e)))
            ...
            switch (
              ...
              case 3:
                return (
                  ...
                  dropEndingNewline(indentString(e, i))
                );
              case 4:
                return (
                  ">" +
              ...
              default:
                throw new nt("impossible error: invalid scalar style");
            }
          })();
        }
        ...
        function detectType(t, e, r) {
          var n, o, i, a, s, u;
          for (
            i = 0, a = (o = r ? t.explicitTypes : t.implicitTypes).length;
            i < a;
            i += 1
          )
            if (
              ...
              if (
                ...
                if (
                  ...
                  "[object Function]" === Ht.call(s.represent))
                )
                  n = s.represent(e, u);
                else {
                  if (!Yt.call(s.represent, u))
                    throw new nt(
                      "!<" +
                        s.tag +
        ...
        function writeNode(t, e, r, n, o, i, a) {
          ...
          if (
            ...
            if (
              (p && l && !t.usedDuplicates[f] && (t.usedDuplicates[f] = !0),
              "[object Object]" === u)
            )
              n && 0 !== Object.keys(t.dump).length
                ? (!(function writeBlockMapping(t, e, r, n) {
                    ...
                    if (!0 === t.sortKeys) p.sort();
                      ...
                      throw new nt("sortKeys must be a boolean or a function");
                ...
                : (!(function writeFlowSequence(t, e, r) {
                    ...
                    for (n = 0, o = r.length; n < o; n += 1)
                      ((i = r[n]),
                        ...
                        (writeNode(t, e, i, !1, !1) ||
                          (void 0 === i && writeNode(t, e, null, !1, !1))) &&
                          ("" !== a && (a += "," + (t.condenseFlow ? "" : " ")),
                          (a += t.dump)));
                    ((t.tag = s), (t.dump = "[" + a + "]"));
                  })(t, e, t.dump),
              ...
              if ("[object String]" !== u) {
                ...
                throw new nt("unacceptable kind of an object to dump " + u);
              }
        ...
        function getDuplicateReferences(t, e) {
          var r,
            ...
            o = [],
            i = [];
          for (inspectNode(t, o, i), r = 0, n = i.length; r < n; r += 1)
            e.duplicates.push(o[i[r]]);
        ...
        function inspectNode(t, e, r) {
          ...
          if (null !== t && "object" == typeof t)
            if (-1 !== (o = e.indexOf(t))) -1 === r.indexOf(o) && r.push(o);
              ...
              for (o = 0, i = t.length; o < i; o += 1) inspectNode(t[o], e, r);
            else
              for (o = 0, i = (n = Object.keys(t)).length; o < i; o += 1)
                inspectNode(t[n[o]], e, r);
        }
        ...
        const te = "configs_update",
          ee = "configs_toggle";
        function update(t, e) {
          return { type: te, payload: { [t]: e } };
        }
        function toggle(t) {
          return { type: ee, payload: t };
        }
        const loaded = () => () => {},
          downloadConfig = (t) => (e) => {
            const {
                ...
                : e(
                    ((t, e) => {
                      try {
                        ...
                        return (
                          e && e.errActions.newThrownErr(new Error(t)),
                          {}
                        );
                      }
                    })(o.text, r),
          ...
          re = {
            [te]: (t, e) => t.merge((0, i.fromJS)(e.payload)),
            [ee]: (t, e) => {
              const r = e.payload,
                n = t.get(r);
              return t.set(r, !n);
        ...
        var ne = __webpack_require__(7248),
          oe = __webpack_require__.n(ne),
          ie = __webpack_require__(7666),
          ae = __webpack_require__.n(ie);
            ...
            class WithErrorBoundary extends n.Component {
              render() {
                return n.createElement(
                  ...
                  n.createElement(e, ae()({}, this.props, this.context)),
                );
              }
            }
            var s;
        ...
        const ue = ErrorBoundary,
          ce = [
            top_bar,
            function configsPlugin() {
              return {
                statePlugins: {
                  configs: { reducers: re, actions: t, selectors: e },
                },
              };
            },
            stadalone_layout,
            (
              ...
              ({ getSystem: r }) => {
                ...
                return {
                  fn: {
                    componentDidCatch: se,
                    withErrorBoundary: withErrorBoundary(r),
                  },
                  components: { ErrorBoundary: ue, Fallback: fallback },
                  wrapComponents: o,
                };
              }
            )({
