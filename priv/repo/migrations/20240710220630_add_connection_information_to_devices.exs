defmodule NervesHub.Repo.Migrations.AddConnectionInformationToDevices do
  ...
  def up() do
    ...
    execute(
      "UPDATE devices SET connection_status = 'disconnected', connection_established_at = last_communication, connection_disconnected_at = last_communication, connection_last_seen_at = last_communication WHERE last_communication IS NOT NULL"
    )
  end
