defmodule NervesHub.Plugs.AllowUninvitedSignupsTest do
  ...
  describe "web" do
    setup do
      conn =
        ...
        |> dispatch(NervesHubWeb.Endpoint, :get, "/")
    ...
    test "user is redirected when signups are disabled", %{conn: conn} do
      ...
      conn = NervesHub.Plugs.AllowUninvitedSignups.call(conn, [])
    ...
    test "user is not redirected when signups are enabled", %{conn: conn} do
      ...
      conn_through = NervesHub.Plugs.AllowUninvitedSignups.call(conn, [])
  ...
  describe "api" do
    setup do
      conn =
        ...
        |> dispatch(NervesHubWeb.API.Endpoint, :post, "/users/register")
