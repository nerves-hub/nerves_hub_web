...
Mimic.copy(NervesHub.ManagedDeployments.Orchestrator)
...
Mimic.copy(NervesHub.ManagedDeployments.OrchestratorRegistration)
Mimic.copy(NervesHub.ManagedDeployments.Orchestrator.DefaultCoordinator)
...
Mimic.copy(NervesHub.Devices.Health)
Mimic.copy(NervesHub.Devices.Metrics)
