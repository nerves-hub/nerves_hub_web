  ...
  describe "available update" do
    ...
    test "available update exists", %{
      ...
      {:ok, {_release, deployment_group}} =
        ManagedDeployments.create_deployment_release(deployment_group, %{firmware_id: firmware.id}, user)
    ...
    test "available update exists but deployment is not active", %{
      ...
      NervesHub.ManagedDeployments.create_deployment_release(deployment_group, %{firmware_id: firmware.id}, user)
