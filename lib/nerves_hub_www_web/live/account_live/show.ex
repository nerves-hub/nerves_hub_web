defmodule NervesHubWWWWeb.AccountLive.Show do
  ...
  def render(%{live_action: :new_token} = assigns) do
    ~L"""
    <%= form_for @changeset, "#", [class: "form-group", phx_submit: "save-token"], fn f -> %>
        ...
        <tr class="item">
          ...
          <td class="actions">
            ...
            <div class="dropdown options">
              <a class="dropdown-toggle options" href="#" id="<%= token.id %>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
