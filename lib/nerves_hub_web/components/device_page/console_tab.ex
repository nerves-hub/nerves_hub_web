        ...
        <.async_result :let={online?} assign={@console_active?}>
          <:loading>
            <div class="size-full flex bg-black" style="background-color: rgb(14, 16, 25);">
              <div :if={authorized?(:"device:console", @current_scope)} class="grow flex justify-center items-center p-6 gap-6 text-medium font-mono">
          ...
          <div id="console-and-chat" class="size-full flex bg-black" phx-update="ignore" style="background-color: rgb(14, 16, 25);">
            <div :if={authorized?(:"device:console", @current_scope) && online?} id="dropzone" class="grow flex p-12 gap-6 relative" style="background-color: rgb(14, 16, 25);">
