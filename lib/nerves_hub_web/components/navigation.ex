      ...
      <ul role="list" class="flex flex-1 flex-col">
        <li>
          <ul role="list">
            <.nav_link
              label="Devices"
              path={~p"/org/#{@org.name}/#{@product.name}/devices"}
              current={@current}>
              <path
            ...
            <.nav_link
              label="Deployments"
              path={~p"/org/#{@org.name}/#{@product.name}/deployments"}
              current={@current}>
                <path
            ...
            <.nav_link
              label="Firmware"
              path={~p"/org/#{@org.name}/#{@product.name}/firmware"}
              current={@current}>
                <path
            ...
            <.nav_link
              label="Artifacts"
              path={~p"/org/#{@org.name}/#{@product.name}/archives"}
              current={@current}>
                  <path
            ...
            <.nav_link
              ...
              path={~p"/org/#{@org.name}/#{@product.name}/scripts"}
              current={@current}>
              <path
            ...
            <.nav_link
              label="Settings"
              path={~p"/org/#{@org.name}/#{@product.name}/settings"}
              current={@current}>
              <path
