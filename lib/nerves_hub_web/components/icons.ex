defmodule NervesHubWeb.Components.Icons do
  ...
  def icon(%{name: "close"} = assigns) do
    ~H"""
    <svg class={["size-5", @class]} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {@rest}>
  ...
  def icon(%{name: "unknown"} = assigns) do
    ~H"""
    <svg class={["stroke-base-500 size-4 stroke-2", @class]} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  def icon(%{name: "healthy"} = assigns) do
    ~H"""
    <svg class={["stroke-success size-4 stroke-2", @class]} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  def icon(%{name: "warning"} = assigns) do
    ~H"""
    <svg class={["stroke-warning size-4 stroke-2", @class]} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  def icon(%{name: "unhealthy"} = assigns) do
    ~H"""
    <svg class={["stroke-alert size-4 stroke-2", @class]} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
