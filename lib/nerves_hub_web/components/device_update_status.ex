    ...
    cond do
      Devices.device_in_penalty_box?(device) ->
        ...
        <div class="relative z-20" id={"update-status-#{@device.id}"} phx-hook="ToolTip" data-placement="top">
          <svg class="size-4 stroke-warning z-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
            <path
      ...
      device.updates_enabled ->
        ~H"""
        <svg title="Updates enabled" xmlns="http://www.w3.org/2000/svg" class="size-4 stroke-success z-10" viewBox="0 0 16 16" fill="none">
          <path
      ...
      true ->
        ~H"""
        <div class="relative z-20" id={"update-status-#{@device.id}"} phx-hook="ToolTip" data-placement="top">
          <svg title="Updates disabled" xmlns="http://www.w3.org/2000/svg" class="size-4 stroke-alert z-10" viewBox="0 0 16 16" fill="none">
            <path
