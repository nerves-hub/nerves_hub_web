defmodule NervesHubWeb.Components.Sorting do
  ...
  def sort_icon(assigns) do
    ~H"""
    <div class="flex items-center group whitespace-nowrap">
      {@text}
      ...
      <svg :if={@selected_field == @field && (@selected_direction == "desc" || is_nil(@selected_direction))} class="ml-auto w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
