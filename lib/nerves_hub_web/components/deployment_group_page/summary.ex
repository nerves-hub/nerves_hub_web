defmodule NervesHubWeb.Components.DeploymentGroupPage.Summary do
  ...
  def update(assigns, socket) do
    ...
    |> assign(:update_stats, UpdateStats.stats_by_deployment(assigns.deployment_group))
    |> ok()
  end
  ...
  def render(assigns) do
    ...
    {@deployment_group.connecting_code}
          ...
          <div :if={Enum.any?(@update_stats)} class="flex flex-col gap-2 p-4 rounded border border-zinc-700 bg-zinc-900 shadow-device-details-content">
            <div class="h-9 flex items-start justify-between">
