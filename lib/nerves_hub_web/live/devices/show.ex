defmodule NervesHubWeb.Live.Devices.Show do
  ...
  defp tab(assigns) do
    ...
    <.link
      ...
      class="text-base-300 relative -bottom-px h-11 px-6 py-2 text-sm font-normal hover:border-b hover:border-indigo-500 data-[selected=true]:border-b data-[selected=true]:border-indigo-500 data-[selected=true]:text-base-50"
